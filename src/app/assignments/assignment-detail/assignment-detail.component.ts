...
export class AssignmentDetailComponent implements OnInit {
  ...
  getAssignment() {
    ...
    this.assignmentsService.getAssignment(id).subscribe(
      assignment => this.passedAssignment = assignment
    );
  }
  onAssignmentSubmitted() {
    this.passedAssignment.submitted = true;
    this.assignmentsService.updateAssignments(this.passedAssignment).subscribe(
      res => console.log(res)
    );
  }

  onDelete() {
    this.assignmentsService.deleteAssignment(this.passedAssignment).subscribe(
